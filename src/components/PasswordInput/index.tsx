...
export default class PasswordInput extends React.Component<IInputDefaultProps, IInputDefaultState> {
  ...
  private validateInput(val: string | undefined): string {
    ...
    if (!pswRegex.test(val)) return "Password must be eight characters or longer";
